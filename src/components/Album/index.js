...
export default class Album extends Component {
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="text-center">{this.getFormat()}</div>
  ...
  getSongsToPlay() {
    ...
    album.songs.forEach(song => {
      ...
      if (disks[disk] === undefined) disks[disk] = { disk: disk, songs: [] };
    ...
    disks.forEach(disk => {
      disk.songs.forEach(song => {
        ...
        if (song.minRank) newSong.minRank = song.minRank;
    ...
    var views = [
      {
        ...
        link: '/tracks',
        component: Tracks,
        data: this.getDataForTracksView(album)
      }
    ];
