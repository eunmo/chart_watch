...
const gradients = {
  purple:
    'linear-gradient(165deg, #1a2a6c, #b21f1f, #fd9b2d, #b21f1f, #1a2a6c)', // King Yna
...
const renders = {
  purple: props => {
    document.body.style.backgroundImage = gradients.purple;
    return null;
  },
  green: props => {
    document.body.style.backgroundImage = gradients.green;
    return null;
  },
  pink: props => {
    document.body.style.backgroundImage = gradients.pink;
    return null;
  }
};
